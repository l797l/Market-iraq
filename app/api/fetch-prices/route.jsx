export async function GET() {
  try {
    ...
    const priceMatch = chunk.match(/text-success">([\d,]+\.?\d*)<\/td>\s*<td class="text-success">([\d,]+\.?\d*)/);
...
const data = { 
  ...
  console.log('Data:', data);
    ...
    try {
      const backendRes = await fetch('http://localhost:5255/api/GitDataMarketIraqi/priceDinarIQ', {
        method: 'POST',
